...
import autocode.observer.git.GitRepoObservers;
import autocode.observer.git.Repository;
import autocode.observer.git.WebHook;
...
public class GitRepoObserversTest {
    ...
    public void readmeCase() {
        ...
        assertEquals(
                "[]",
                commitMasterWebHook.caughtEvents().toString() // подсчитываем события в вебхуке
        );
        assertEquals(
